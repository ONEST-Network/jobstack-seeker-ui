...
const WorkExperienceCard: React.FC<WorkExperienceCardProps> = ({
  ...
  const { t } = useTranslation('workexperiencecard'); 
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-4 p-4 border-2 border-dashed border-gray-200 rounded-lg">
          <h4 className="font-medium">{t('experience.addTitle')}</h4>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              <Label htmlFor="company">{t('experience.companyLabel')}</Label>
              <Input
                id="company"
            ...
            <div>
              <Label htmlFor="position">{t('experience.positionLabel')}</Label>
              <Input
                id="position"
            ...
            <div className="md:col-span-2">
              <Label htmlFor="description">{t('experience.descriptionLabel')}</Label>
              <Textarea
                id="description"
